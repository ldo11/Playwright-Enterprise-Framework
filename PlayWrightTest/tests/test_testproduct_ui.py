...
class TestTestProductUI:
    ...
    def test_create_client_fail_fast_mismatch(self, auth_page):
        """
        ...
        try:
            ...
            # Ideally we'd use API cleanup, but for this specific isolated test,
            # we can just try to delete it from UI or let the next run handle it.
            pass
